...
const UpdateCategoryForm = ({ onClose, existingTitle, existingDescription, existingImage, categoryId, handleUpdateFromState }) => {
    const [categoryName, setCategoryName] = useState(existingTitle);
    const [categoryDesc, setCategoryDesc] = useState(existingDescription);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            handleUpdateFromState(updatedCategory);
            onClose();
        } catch (err) {
